        ...
        <header id="branding" role="banner">
          ...
          <div id="inner-header" class="clearfix">
                ...
                <div id="site-heading">
                    ...
                    <div id="site-logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo esc_url( get_theme_mod( 'newswire_logo' ) );?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" height="100" width="300" /></a></div>
                    <?php else : ?>
